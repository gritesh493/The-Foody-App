    ...
    <>
      <div className="Header w-full flex items-center h-20 border-b border-gray-200 shadow-lg shadow-gray-200 align-middle px-[11%]">
        ...
        <div className="HeaderLocationContainer flex min-w-fit mr-5 pl-5 py-1 border-l-2">
          <img className="LocationPin w-6 opacity-30" src={locationPin} />
        ...
        <div className="HeaderSearchBarContainer items-center grow min-w-[360px] h-14 my-3 hidden sm:absolute sm:flex sm:items-center sm:justify-center md:justify-end sm:top-20 lg:top-0 lg:relative">
          <div className="flex justify-self-end items-center h-14 w-full max-w-[472px]  bg-slate-200 rounded-xl text-lg">
            <button className="w-full p-2 pl-4 ">
              <input
                type="text"
        ...
        <div className="HeaderLoginContainer ml-2 sm:ml-8 mr-4 flex w-full lg:w-auto justify-end invert">
          <img
            src={login}
            className="w-12 min-w-[48px] opacity-80 rounded-full bg-slate-100 border-4 border-slate-200 justify-self-end"
          />
        </div>
      </div>
    </>
