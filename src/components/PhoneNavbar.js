...
const PhoneNavbar = () => {
  ...
  return (
    <div
      className={
        "phoneNavbarContainer md:hidden w-full justify-around flex items-center h-16 sm:h-20 border border-gray-200 shadow-xl align-middle px-[1%] sm:px-[11%] fixed sm:top-[90vh] top-[92vh] bg-white z-10"
      }
    >
      <Link to={"/"}>
